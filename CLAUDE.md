...
Use the **wecom-send** skill. It handles upload and delivery automatically via `POST http://localhost:8890/api/wecom/send-file`. The `WECOM_USER_ID` is injected at the top of each user message as `[WECOM_USER_ID: ...]`.
